...
class LLMEngine:
    ...
    def _add_processed_request(
        ...
        # logger.info("<yx> processed_inputs: %s", processed_inputs)
    ...
    def _tokenize_prompt(
        ...
        * prompt token ids
        '''
        logger.info("<yx> prompt in _tokenize_prompt: %s", prompt)
    ...
    def _extract_prompt_components(
        ...
        * multi_modal_data
        '''
        logger.info("<yx> inputs in _extract_prompt_components: %s", inputs)
    ...
    def _build_decoder_only_llm_inputs(
        ...
        logger.info("<yx> prompt in _build_decoder_only_llm_inputs: %s", prompt_comps)
    ...
    def _process_decoder_only_prompt(
        ...
        * :class:`LLMInputs` instance
        ...
        logger.info("<yx> prompt_comps in _process_decoder_only_prompt: %s", prompt_comps)
